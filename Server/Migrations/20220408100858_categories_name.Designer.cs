...
namespace waPlanner.Migrations
{
    ...
    [Migration("20220408100858_categories_name")]
    partial class categories_name
    {
            ...
            modelBuilder.Entity("waPlanner.Database.Models.tbOrganization", b =>
                {
                    ...
                    b.HasIndex("CategoryId")
                        .HasDatabaseName("ix_tb_organizations_category_id");
            ...
            modelBuilder.Entity("waPlanner.Database.Models.tbOrganization", b =>
                {
                    b.HasOne("waPlanner.Database.Models.spCategory", "Category")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_tb_organizations_sp_categories_category_id");
