...
namespace waPlanner.Migrations
{
    ...
    [Migration("20220412054325_added_favorites_table")]
    partial class added_favorites_table
    {
            ...
            modelBuilder.Entity("waPlanner.Database.Models.tbFavorites", b =>
                {
                    ...
                    b.HasOne("waPlanner.Database.Models.tbUser", "Staff")
                        .WithMany()
                        .HasForeignKey("StaffId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_tb_favorites_tb_users_staff_id");
